...
class ListaPuroMalteAdapter (var context: Context, var list: List<Cerveja>) : BaseAdapter() {
    ...
    override fun getView(position: Int, p1: View?, p2: ViewGroup?): View {
        ...
        var view = LayoutInflater.from(context).inflate(R.layout.item_puromalte, null)
